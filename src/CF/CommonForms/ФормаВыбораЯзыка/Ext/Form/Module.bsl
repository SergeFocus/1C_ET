...
Процедура ВыбранЯзык()
	...
	Если НЕ Русский Тогда
		Состояние(ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Ждите, локализация") + ".. / Wait for localiZation..", , ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Загружается") + ": " + СокрЛП(ВыберитеВашЯзык));
	КонецЕсли;
...
Процедура ОбновитьТекущийЯзыкИнтерфейса(Знач ВыберитеВашЯзыкБК = Неопределено)
	...
	ВыбранРусский = ЗначениеЗаполнено(ВыберитеВашЯзыкБК) И ВыберитеВашЯзыкБК = РусскийЯзык;
	Если НЕ ВыбранРусский Тогда
		...
		ИначеЕсли ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Болгарский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Болгарский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Немецкий")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Венгерский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Итальянский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Латышский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Литовский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Французский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Чешский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Эстонский")
			ИЛИ ВыберитеВашЯзыкБК = ПредопределенноеЗначение("Справочник.Языки.Польский") Тогда
		...
		ПереводитьИнтерфейсПрограммно = ЛОЖЬ;
		ПользовательСистемы = ПользователиИнформационнойБазы.ТекущийПользователь();
		Если НЕ ПользовательСистемы = Неопределено Тогда

			Если НЕ ПользовательСистемы.Язык = Неопределено
				И НЕ ВРег(ПользовательСистемы.Язык.КодЯзыка) = ВРег(ВыберитеВашЯзыкБК.Код) Тогда

				ПереводитьИнтерфейсПрограммно = ИСТИНА;
			КонецЕсли;
		Иначе
			ПереводитьИнтерфейсПрограммно = ИСТИНА;
		КонецЕсли;

		Константы.ИспользоватьСобственныйПереводЭлементовИнтерфейса.Установить(ПереводитьИнтерфейсПрограммно);
		Константы.ПереводитьЭлементыИнтерфейсаПрограммно.Установить(ПереводитьИнтерфейсПрограммно);
