// sza160308-0324
// sza160302-0500 расчеты в валюте
// sza151223-0343 емейл
// sza151211-0113
// sza151002-0253 pdf
// sza150713-1804
...
Процедура ЗаданиеПараметровИКомпоновкаОтчета()
	...
	Если НЕ ВремяПоследнегоФормирования = '00010101000000'
		И ВремяПоследнегоФормирования >= (ТекущаяДата() - 1) Тогда
	...
	ИначеЕсли ИмяОтчета = "ВедомостьПоВзаиморасчетамВВалюте" Тогда
	...
	ИначеЕсли ИмяОтчета = "ОстаткиИОбороты" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСкладу", ЗначениеЗаполнено(ОтборПоСкладу));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Склад", ОтборПоСкладу);
	ИначеЕсли ИмяОтчета = "ВаловаяПрибыль"
		ИЛИ ИмяОтчета = "ВаловаяПрибыльОтносительноПродаж" Тогда

		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСкладу", ЗначениеЗаполнено(ОтборПоСкладу));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Склад", ОтборПоСкладу);
	ИначеЕсли ИмяОтчета = "ЗакупкаТовара" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоПоставщику", ЗначениеЗаполнено(ОтборПоПоставщику));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Поставщик", ОтборПоПоставщику);
	ИначеЕсли ИмяОтчета = "ПродажиНаборовТовара" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоКлиенту", ЗначениеЗаполнено(ОтборПоКлиенту));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Клиент", ОтборПоКлиенту);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
	ИначеЕсли ИмяОтчета = "ПредставлениеНоменклатурыКонтрагентами" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоКонтрагенту", ЗначениеЗаполнено(ОтборПоКонтрагенту));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("КлиентПоставщик", ОтборПоКонтрагенту);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
	ИначеЕсли ИмяОтчета = "ПродажиКлиентам" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоКлиенту", ЗначениеЗаполнено(ОтборПоКлиенту));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Клиент", ОтборПоКлиенту);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСкладу", ЗначениеЗаполнено(ОтборПоСкладу));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Склад", ОтборПоСкладу);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
	ИначеЕсли ИмяОтчета = "ЦеныНоменклатуры" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоВидуЦен", ЗначениеЗаполнено(ОтборПоВидуЦен));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ВидЦен", ОтборПоВидуЦен);
	ИначеЕсли ИмяОтчета = "Прайс"
		...
		Если ИмяОтчета = "ПрайсВПредставленииКонтрагентов" Тогда
			Если НЕ ЗначениеЗаполнено(ОтборПоКонтрагенту) Тогда
				ОбщегоНазначения.СообщитьПользователю(ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Контрагент не указан!"));
	...
	ИначеЕсли ИмяОтчета = "ПриобретениеИРеализацияКонтрагентам" Тогда
		...
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСкладу", ЗначениеЗаполнено(ОтборПоСкладу));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Склад", ОтборПоСкладу);
	ИначеЕсли ИмяОтчета = "РасчетыСКонтрагентамиВВалюте" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоКонтрагенту", ЗначениеЗаполнено(ОтборПоКонтрагенту));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Контрагент", ОтборПоКонтрагенту);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ТипПоставщик", ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Поставщик"));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ТипКлиент", ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Клиент"));
	...
	ИначеЕсли ИмяОтчета = "ИсторияВаучера" Тогда
		Если НЕ ЗначениеЗаполнено(Ваучер) Тогда
			ОбщегоНазначения.СообщитьПользователю(ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Не указан ваучер!"));
	...
	ИначеЕсли ИмяОтчета = "ОстаткиСУчетомЗаказовПоставщикам" Тогда
		...
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоВидуЦен", ЗначениеЗаполнено(ОтборПоВидуЦен));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ВидЦен", ОтборПоВидуЦен);
	ИначеЕсли ИмяОтчета = "ВыполненныеСотрудникамиРаботы" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСотруднику", ЗначениеЗаполнено(ОтборПоСотруднику));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Сотрудник", ОтборПоСотруднику);
	ИначеЕсли ИмяОтчета = "ЗадействованиеСредствПредприятия" Тогда
	...
	ИначеЕсли ИмяОтчета = "КомплектацииПродукции" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
	ИначеЕсли ИмяОтчета = "ТоварнаяПозиция" Тогда
		Если НЕ ЗначениеЗаполнено(ОтборПоНоменклатуре) Тогда
			ОбщегоНазначения.СообщитьПользователю(ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Не указана номенклатура!"));
	...
	ИначеЕсли ИмяОтчета = "ТоварыУКомиссионеровОстаткиИОбороты" Тогда
		...
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатурнойГруппе", ЗначениеЗаполнено(ОтборПоНоменклатурнойГруппе));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("НоменклатурнаяГруппа", ОтборПоНоменклатурнойГруппе);
	ИначеЕсли ИмяОтчета = "ЦеныНоменклатурыПоставщиков" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоНоменклатуре", ЗначениеЗаполнено(ОтборПоНоменклатуре));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Номенклатура", ОтборПоНоменклатуре);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоВидуЦен", ЗначениеЗаполнено(ОтборПоВидуЦен));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ВидЦен", ОтборПоВидуЦен);
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("НеОтборПоПоставщику", НЕ ЗначениеЗаполнено(ОтборПоПоставщику));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоПоставщику", ОтборПоПоставщику);
	ИначеЕсли ИмяОтчета = "СобытияПредприятия" Тогда
	...
	ИначеЕсли ИмяОтчета = "ВнутренниеЗаказыТовара" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСкладу", ЗначениеЗаполнено(ОтборПоСкладу));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Склад", ОтборПоСкладу);
	ИначеЕсли ИмяОтчета = "РабочееВремяСотрудников" Тогда
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ОтборПоСотруднику", ЗначениеЗаполнено(ОтборПоСотруднику));
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("Сотрудник", ОтборПоСотруднику);
...
Функция   ОбработатьПолученныйШтрихкодНаСервере(Знач ТекКод)
	...
	Если НЕ ПустаяСтрока(ТекКод) Тогда
		Результат = ИСТИНА;
		ОтборПоНоменклатуре = ОбщийМодульТоварСервер.НайтиНоменклатуруПоШтрихКоду(ТекКод, ЛОЖЬ, ИСТИНА, ДатаОкончания);
		...
		Иначе
			...
			Если НЕ ОстановитьПоиск
				...
				ОтборПоСотруднику = ОбщийМодульСервер.НайтиСотрудникаПоШтрихКоду(ТекКод);
			...
			Если НЕ ОстановитьПоиск
				...
				РезультатКонтрагент = ОбщийМодульСервер.НайтиКонтрагентаПоШтрихКоду(ТекКод);
			...
			Если НЕ ОстановитьПоиск
				...
				ОтборПоОрганизации = ОбщийМодульСервер.НайтиКонтрагентаПоШтрихКоду(ТекКод, , , ИСТИНА);
			...
			Если НЕ ОстановитьПоиск
				...
				Ваучер = ОбщийМодульТоварСервер.НайтиВаучерПоШтрихКоду(ТекКод);
	...
	Если ПодключатьСканер Тогда
		...
		Если Источник = "ПодключаемоеОборудование"
			...
			Если ИмяСобытия = "ScanData" Тогда
				...
				Если ОбработатьПолученныйШтрихкодНаСервере(ШтрихКод) Тогда
					ЗаданиеПараметровИКомпоновкаОтчета();
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
...
Процедура ОтборПоКонтрагентуОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("Клиенты", ДанныеВыбора, Текст, ОтборПоКонтрагенту);
	ЗаданиеПараметровИКомпоновкаОтчета();
...
Процедура ОтборПоНоменклатуреОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("Номенклатура", ДанныеВыбора, Текст, ОтборПоНоменклатуре);
...
Процедура ОтборПоОтветственномуОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("Пользователи", ДанныеВыбора, Текст, ОтборПоОтветственному);
	ЗаданиеПараметровИКомпоновкаОтчета();
...
Процедура ОтборПоПоставщикуОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("Поставщики", ДанныеВыбора, Текст, ОтборПоПоставщику);
	ЗаданиеПараметровИКомпоновкаОтчета();
...
Процедура ОтборПоСкладуОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("Склады", ДанныеВыбора, Текст, ОтборПоСкладу);
	ЗаданиеПараметровИКомпоновкаОтчета();
...
Процедура ОтборПоСтатьеОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	ОбщийМодульКлиент.ПоискОшибкиПриВводеТекстаПользователем("СтатьиДвиженияДенег", ДанныеВыбора, Текст, ОтборПоСтатье);
	ЗаданиеПараметровИКомпоновкаОтчета();
...
Процедура ОтправитьEmail(Команда)
	...
	Если ПустаяСтрока(ЭлектроннаяПочта) Тогда
		ПоказатьВводСтроки(Новый ОписаниеОповещения("ОтправитьEmailЗавершение", ЭтотОбъект, Новый Структура("ЭлектроннаяПочта", ЭлектроннаяПочта)), ЭлектроннаяПочта, ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Укажите электронный адрес"), 100, ЛОЖЬ);
	Иначе
		ОтправитьEmailФрагмент();
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура ОтправитьEmailЗавершение(Строка, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ОтправитьEmailФрагмент()

	Если ПустаяСтрока(ТекстСопровождения) Тогда
		ТекстСопровождения = ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Информация в вложенном файле..");
	КонецЕсли;

	ОбщийМодульСервисСервер.ОправитьПоEMAILКонтрагентуНаСервере(ТекстСопровождения, Результат, "" + НаименованиеОтчета, ЭлектроннаяПочта);
...
Процедура ПриОткрытии(Отказ)     // ПРИ ОТКРЫТИИ
	...
	Если ЕстьПериод Тогда
		Если НЕ ЗначениеЗаполнено(ПериодДляОтчета) Тогда
			...
			ИначеЕсли ИмяОтчета = "ИзмененияОбъектаКонфигурации"
				...
				ИЛИ ИмяОтчета = "ПродажиНаборовТовара"
				ИЛИ ИмяОтчета = "ИсторияВаучера"
				ИЛИ ИмяОтчета = "ТоварнаяПозиция" Тогда
	...
	Если ПодключатьСканер Тогда
		...
		Если ОбщийМодульКлиент.ИспользоватьПодключаемоеОборудование()
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ИмяОтчета = "ОстаткиИОбороты" Тогда
		...
		ЕстьКоличество   = ИСТИНА;
		Элементы.ОтборПоСкладу.Видимость = ИСТИНА;
	ИначеЕсли ИмяОтчета = "ЧистаяПрибыль" Тогда
		КодДоступа 	= "002600";
	ИначеЕсли ИмяОтчета = "ВаловаяПрибыль"
		ИЛИ ИмяОтчета = "ВаловаяПрибыльОтносительноПродаж" Тогда
		...
		Элементы.ОтборПоНоменклатуре.Видимость = ИСТИНА;
		Элементы.ОтборПоСкладу.Видимость = ИСТИНА;
	ИначеЕсли ИмяОтчета = "ВыполнениеРабот" Тогда
		КодДоступа 	= "000690";
	ИначеЕсли ИмяОтчета = "ЗакупкаТовара" Тогда
		КодДоступа 	= "000656";
		ЕстьКоличество	 = ИСТИНА;
	...
	ИначеЕсли ИмяОтчета = "ПродажиКлиентам" Тогда
		...
		Элементы.ОтборПоНоменклатуре.Видимость = ИСТИНА;
		Элементы.ОтборПоСкладу.Видимость = ИСТИНА;
	ИначеЕсли ИмяОтчета = "СторнированыеДокументы" Тогда
		КодДоступа 	= "002470";
	ИначеЕсли ИмяОтчета = "ТаблицыСДанными" Тогда
		ЕстьПериод  = ЛОЖЬ;
	ИначеЕсли ИмяОтчета = "ЦеныНоменклатуры" Тогда
		КодДоступа 	= "000200";
		Элементы.ОтборПоВидуЦен.Видимость = ИСТИНА;
	...
	ИначеЕсли ИмяОтчета = "КассоваяКнига" Тогда
		...
		Элементы.ОтборПоХранилищуДенег.Видимость = ИСТИНА;
		Элементы.ОтборПоСтатье.Видимость = ИСТИНА;
	ИначеЕсли ИмяОтчета = "ОтветственностьЗаСредства" Тогда
		КодДоступа = "001600";
	ИначеЕсли ИмяОтчета = "ОказаниеУслугПоПозициямНомерам" Тогда
		КодДоступа = "001290";
		ЕстьКоличество = ИСТИНА;
	...
	ИначеЕсли ИмяОтчета = "ТоварнаяПозиция" Тогда
		...
		Элементы.ОтборПоСкладу.Видимость = ИСТИНА;
		Элементы.ОтборПоВидуЦен.Видимость = ИСТИНА;
	ИначеЕсли ИмяОтчета = "УсловияДоступаПользователей" Тогда
		КодДоступа = "000100";
		ЕстьПериод = ЛОЖЬ;
	...
	Если НЕ Отказ Тогда
		...
		Если ЗначениеЗаполнено(Параметры.ОтборПоПоставщику) Тогда
			УстановленОтборПоПоставщику = Параметры.ОтборПоПоставщику;
		КонецЕсли;

		Если ЗначениеЗаполнено(Параметры.ОтборПоКонтрагенту) Тогда
			УстановленОтборПоКонтрагенту = Параметры.ОтборПоКонтрагенту;
		КонецЕсли;
		...
		Если НЕ ПустаяСтрока(Параметры.ТекстСопровождения) Тогда
			ТекстСопровождения = Параметры.ТекстСопровождения;
		КонецЕсли;
		...
		ЕстьПочта = НЕ ОбщийМодульПовтор.ПолучитьЗначениеНастройкиИлиКонстанты("ЭлектроннаяПочтаПользователь", ИСТИНА) = "";
		Элементы.РезультатОтправитьРуководителю.Видимость = ЕстьПочта;
		Элементы.РезультатОтправитьEmail.Видимость = ЕстьПочта;
...
&НаКлиенте
Процедура РасчетСуммыПоЯчейкам(Знач ДокументДляПечати)
...
Процедура СохранитьВФайлPDFФрагмент()
	...
	ДиалогДляВыбораФайла.ПолноеИмяФайла			=   "" + ЭтаФорма.Заголовок + ".pdf";
...
Процедура СохранитьВФайлФорматаExcel(Команда)
	...
	#Если ВебКлиент Тогда
		Если Не ПодключитьРасширениеРаботыСФайлами() Тогда
			...
			НачатьУстановкуРасширенияРаботыСФайлами(Новый ОписаниеОповещения("СохранитьВФайлФорматаExcelЗавершение", ЭтотОбъект));
...
&НаКлиенте
Процедура СохранитьВФайлФорматаExcelЗавершение(ДополнительныеПараметры) Экспорт
...
Процедура СохранитьВФайлФорматаExcelФрагмент()
	...
	ДиалогДляВыбораФайла.Фильтр					=	ДиалогФильтр;
	ДиалогДляВыбораФайла.Расширение				=	ДиалогРасширение;
	ДиалогДляВыбораФайла.ПолноеИмяФайла			=   "" + ЭтаФорма.Заголовок + ".xls";
	ДиалогДляВыбораФайла.МножественныйВыбор		=	ЛОЖЬ;
	ДиалогДляВыбораФайла.ПредварительныйПросмотр	=	ЛОЖЬ;
	ДиалогДляВыбораФайла.ИндексФильтра			=	0;
...
Процедура УстановитьПереданныеПараметры()
	...
	Если ЗначениеЗаполнено(УстановленОтборПоКонтрагенту) Тогда
		ОтборПоКонтрагенту = УстановленОтборПоКонтрагенту;
	КонецЕсли;

	Если ЗначениеЗаполнено(УстановленОтборПоПоставщику) Тогда
		ОтборПоПоставщику = УстановленОтборПоПоставщику;
	КонецЕсли;
