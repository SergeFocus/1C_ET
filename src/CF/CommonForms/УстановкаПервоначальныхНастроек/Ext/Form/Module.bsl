...
Процедура КаталогДляРезервированияБазыДанныхОткрытие(Элемент, СтандартнаяОбработка)
	...
	ДиалогВыбФайла.Показать(Новый ОписаниеОповещения("КаталогДляРезервированияБазыДанныхОткрытиеЗавершение", ЭтаФорма, Новый Структура("ДиалогВыбФайла", ДиалогВыбФайла)));
...
//	КонецЕсли;
	...
	Если НЕ ЗаконченаПервоначальнаяНастройка Тогда
		...
		ИначеЕсли не Валюта.Наименование = "грн." тогда // уже не в Украине
