...
#Если НЕ ВебКлиент Тогда
	...
	Для Каждого Путь Из МассивИмен Цикл
		...
		Если Файл.Существует() Тогда
			ОбратныйВызов = Новый ОписаниеОповещения("ЗагрузкаНастроекЗавершение", Объект);
...
Процедура ЗагрузитьШаблон(Команда)
	...
	ОбратныйВызов = Новый ОписаниеОповещения("ЗагрузитьШаблонЗавершение", Объект);
...
Процедура ПеречитатьФайл(Команда)
	...
	Если НЕ ПустаяСтрока(МестоположениеФайла) Тогда
		Если Модифицированность Тогда
			ОбратныйВызов = Новый ОписаниеОповещения("ПеречитатьФайлЗавершение", Объект, МестоположениеФайла);
...
Процедура СохранитьКак(Команда)
	...
	Если НЕ Результат Тогда
		Возврат;
	КонецЕсли;
	ОбратныйВызов = Новый ОписаниеОповещения("СохранитьКакЗавершение", Объект, ДиалогВыбора.ПолноеИмяФайла);
...
Процедура РедакторУсловийСобытия(Команда)
	...
	ОбратныйВызов = Новый ОписаниеОповещения("РедакторУсловийСобытияЗавершение", Объект);
...
Процедура РедакторУсловийКолонки(Команда)
	...
	ОбратныйВызов = Новый ОписаниеОповещения("РедакторУсловийКолонкиЗавершение", Объект);
...
Процедура ОчиститьНастройкиТЖ(Команда)
	...
	ОбратныйВызов = Новый ОписаниеОповещения("ОчиститьНастройкиТЖЗавершение", Объект);
