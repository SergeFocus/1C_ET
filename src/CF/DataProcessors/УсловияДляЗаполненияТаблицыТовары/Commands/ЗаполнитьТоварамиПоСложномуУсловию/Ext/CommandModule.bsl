...
Процедура ДозаполнитьНоменклатурой(ДокументСсылка, СтруктураОтбора)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Исключение //Записи ДокументОбъект
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Ошибка при попытке записи документа") + ": " + ДокументОбъект + " " + ОписаниеОшибки();
			Сообщение.Сообщить();
