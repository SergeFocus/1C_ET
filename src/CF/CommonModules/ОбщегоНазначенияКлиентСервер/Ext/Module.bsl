...
Функция   ОкруглитьДо(Знач ЗначениеДляОкругления, Знач ЗнаковПослеЗапятой = 2) Экспорт
	...
	Результат = Окр(ЗначениеДляОкругления * ЧислоУмножения, 0, РежимОкругления.Окр15как20) / ЧислоУмножения; 
	
	Возврат Результат;
	
КонецФункции // ОкруглитьДо
...
// Проверить, равен ли объект значению и изменить его
Функция   ПроверитьРавенствоИлиИзменить(ОбъектПроверкиИзменения, Знач ЗначениеПроверкиИзменения) Экспорт
...
КонецФункции // ПроверитьРавенствоИлиИзменить
...
Процедура СообщитьПользователю(
	...
	ОбщегоНазначения.СообщитьПользователю(ТекстСообщенияПользователю, КлючДанных, Поле, ПутьКДанным, Отказ, ПисатьВЖурналЗапрещено);
КонецПроцедуры
