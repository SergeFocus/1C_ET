...
Процедура СоздатьЗаказаПоставщику(Команда)
	...
	ОткрытьФорму("Документ.ПоступленияТовара.ФормаОбъекта", ПараметрыФормы);
...
Процедура СоздатьПеремещение(Команда)
	ОткрытьФорму("Документ.ПеремещенияТовара.ФормаОбъекта");
КонецПроцедуры

&НаКлиенте
Процедура СоздатьПоступление(Команда)
	ОткрытьФорму("Документ.ПоступленияТовара.ФормаОбъекта");
КонецПроцедуры

&НаКлиенте
Процедура СоздатьРасход(Команда)
	ОткрытьФорму("Документ.РасходыТовара.ФормаОбъекта");
КонецПроцедуры
