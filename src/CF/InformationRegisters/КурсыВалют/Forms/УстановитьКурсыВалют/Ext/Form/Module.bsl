...
Процедура УстановитьКурсы(Команда)
	...
	РасчитатьВсеЗависимыеЦены(Новый ОписаниеОповещения("УстановитьКурсыЗавершение", ЭтаФорма), СписокИзмененныхВалют);
...
&НаКлиенте
Процедура РасчитатьВсеЗависимыеЦены(Знач Оповещение, Знач СписокИзмененныхВалют)
	...
	РасчитатьВсеЗависимыеЦеныФрагмент(Оповещение);
КонецПроцедуры
...
&НаКлиенте
Процедура РасчитатьВсеЗависимыеЦеныФрагмент(Знач Оповещение)
	...
	Для Каждого строкакурса из КурсыВалют Цикл
		...
		Если НеИзменять
			...
			Исключение 
				...
				Сообщение.Текст = ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Ошибка при попытке записи курса") + ": " + ТекстОписаниеОшибки;
				Сообщение.Сообщить();
			КонецПопытки; 
