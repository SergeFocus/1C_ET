...
Функция   ЕстьЗависимыеЦены() 
	...
	Запрос.УстановитьПараметр("ВалютаЦены", Запись.Валюта);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)          // ПРИ СОЗДАНИИ НА СЕРВЕРЕ
	...
	НаименованиеБазововйВалюты = Справочники.Валюты.ОсновнаяВалюта.Наименование ;
	ВыяснитьТекущийКурс();
...
КонецПроцедуры //обртныйпересчет
