	...
	Процедура ОбработкаПроведения(Отказ, РежимПроведения)
		...
		Иначе
			Если НЕ Отказ Тогда
				...
				|	ВЫРАЗИТЬ(Товары.Комментарий КАК СТРОКА(1000)) КАК Комментарий,
				...
				ЗаменитьЗакупки = ЗначениеЗаполнено(ПартияПриобретенияПоставщик)
