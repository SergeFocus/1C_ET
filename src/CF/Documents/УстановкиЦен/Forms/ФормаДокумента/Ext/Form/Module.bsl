...
Процедура проверитьЗависимостьВидаЦен()
	...
	Элементы.ВидЦенФормулаРасчетаОтБазовогоВидаЦены.Видимость = ЗначениеЗаполнено(Объект.ВидЦен.ФормулаРасчетаОтБазовогоВидаЦены);
	Элементы.ВидЦенПроцентОтБазовойЦены.Видимость = ЗначениеЗаполнено(Объект.ВидЦен.ПроцентОтБазовойЦены);
	Элементы.ВидЦенОсновнойВидЦен.Видимость = ЗначениеЗаполнено(Объект.ВидЦен.ОсновнойВидЦен);
