...
Процедура ОбработатьБлокировку(Знач ПриСозданииФормы = ЛОЖЬ)
	...
	Если ОбщийМодульСервер.ОбработатьБлокировку(Объект, ЭтаФорма, ПриСозданииФормы, "002352") Тогда			
		...
		Элементы.УстановитьОднуЦенуДляВсехСтрок.Видимость	= ЛОЖЬ;
	...
	Иначе
		...
		Элементы.УстановитьОднуЦенуДляВсехСтрок.Видимость	= ИСТИНА;
...
Процедура ПриОткрытииФрагмент()
	...
	Перем ОписаниеОшибки, ПоддерживаемыеТипыВО, ТекстСообщения;
