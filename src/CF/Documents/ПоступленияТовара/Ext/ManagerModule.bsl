...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		если ЗначениеЗаполнено(КлиентПоставщик) 
			и не КлиентПоставщик.НаименованиеДляПечати = "" Тогда
...
Процедура ПечатьБезСерий(ТабДок, Ссылка) Экспорт
	...
	|	Документ.ПоступленияТовара КАК ПоступленияТовара
	|ГДЕ
	|	ПоступленияТовара.Ссылка = &Ссылка";
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	ИначеЕсли Данные.Ссылка.ЭтоЗаказ Тогда
		Представление = ОбщийМодульПовтор.ПолучитьТекстНаЯзыке("Заказ Поставщику") + " " + Данные.Ссылка.Номер + " - " + формат(Данные.Ссылка.Дата, "ДФ='dd.MM.yy ЧЧ:мм'");	
		СтандартнаяОбработка = Ложь;
	КонецЕсли;
