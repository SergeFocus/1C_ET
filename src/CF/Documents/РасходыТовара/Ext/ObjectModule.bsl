	...
	Для Каждого СтрокаСоставаНабора из Номенклатура.Состав цикл
		...
		Иначе
			...
			Если НЕ Отказ Тогда
				...
				ЦенаСписания = ОбщийМодульСервер.ПолучитьЦенуСписания(НоменклатураСостава, Количество, Дата, , ПредопределенныйТовар);
						...
						Если НЕ Отказ Тогда
							...
							Если НЕ ЭтоНабор Тогда 				
								...
								Если ПредопределенныйТовар Тогда
									...
									ЦенаСписания = ОбщийМодульСервер.ПолучитьЦенуСписания(Номенклатура, Количество, Дата, , ИСТИНА);
