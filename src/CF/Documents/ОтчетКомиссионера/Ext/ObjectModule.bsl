		...
		Иначе
			...
			Если ВестиУчетВаловойПрибыли Тогда  				
				Если Этоклиент тогда					
					...
					ЦенаСписания = ОбщийМодульСервер.ПолучитьЦенуСписания(НоменклатураСостава, Количество, ДатаВозврата, , ПредопределенныйТовар);
				...
				Если НЕ ОбщийМодульПовтор.ЭтоНабор(Номенклатура) Тогда
					...
					Если ВестиУчетВаловойПрибыли Тогда
						...
						Если ПредопределенныйТовар Тогда
							...
							ЦенаСписания = ОбщийМодульСервер.ПолучитьЦенуСписания(Номенклатура, Количество, ДатаВозврата, , ИСТИНА);
