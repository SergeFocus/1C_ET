	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения) Тогда
		...
		Для Каждого СтрокаТовара из Товары Цикл
			...
			Если ИспользоватьСкидкиПС Тогда
				...
				ПроцентСкидки = ОбщийМодульСервер.ПолучитьПроцентСкидкиНаСервере(СтрокаТовара.Номенклатура, СтрокаТовара.КоличествоПоФакту, ВидЦен, , , Склад, Дата); // акция ном
	...
	Иначе		
		...
		Если НЕ отказ
			...
			Для Каждого ТекСтрокаТовара Из Товары Цикл
				...
				КомментарийСтроки = ?(НЕ ПустаяСтрока(ТекСтрокаТовара.Коментарий), ТекСтрокаТовара.Коментарий, Комментарий);
