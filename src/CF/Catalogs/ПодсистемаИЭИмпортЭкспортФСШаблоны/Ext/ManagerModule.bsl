...
Процедура Друкувати(ТабДок, Ссылка) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПодсистемаИЭИмпортЭкспортФСШаблоны.АдресФайла,
	...
	|	ПодсистемаИЭИмпортЭкспортФСШаблоны.СоздаватьКлиентовПоОКПО,
	...
	|	)
	|ИЗ
	|	Справочник.ПодсистемаИЭИмпортЭкспортФСШаблоны КАК ПодсистемаИЭИмпортЭкспортФСШаблоны
	|ГДЕ
	|	ПодсистемаИЭИмпортЭкспортФСШаблоны.Ссылка В (&Ссылка)";
