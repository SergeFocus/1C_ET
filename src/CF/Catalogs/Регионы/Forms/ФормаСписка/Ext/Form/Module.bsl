...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УчитыватьЛокациюКонтрагентов = ОбщийМодульПовтор.ПолучитьЗначениеНастройкиИлиКонстанты("УчитыватьЛокациюКонтрагентов");
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Если УчитыватьЛокациюКонтрагентов Тогда
		ОбновитьСписокЛокацийНаСервере();	
	КонецЕсли;
	
КонецПроцедуры

&НаСервере
Процедура ОбновитьСписокЛокацийНаСервере()
