	...
	Если НЕ Отказ 
		...
		Если НЕ ЭтоГруппа 
			...
			Если НЕ ЗначениеЗаполнено(Пол) Тогда
				...
				Если КонецНаименования = "на" Тогда
			...
			Отказ = ОбщийМодульСервер.ПроверитьУникальностьЗначенияРеквизита(Отказ, "Клиенты", Наименование, Ссылка);
		...
		ИначеЕсли Модифицированность Тогда // Группа
...
Процедура ПриЗаписи(Отказ)
	...
	Если НЕ Отказ Тогда
		...
		Если ОбщийМодульПовтор.ПолучитьЗначениеНастройкиИлиКонстанты("ВестиУчетВидовДеятельности")
			...
			|ИЗ Справочник.Клиенты.ВидыДеятельности КАК ВидыДеятельности
