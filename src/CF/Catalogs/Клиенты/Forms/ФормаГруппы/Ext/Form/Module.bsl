...
Функция   ЕстьПодчиненныеГруппеЭлементы(Ссылка) 
...
КонецФункции // ЕстьПодчиненныеГруппеЭлементы
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)          // ПРИ СОЗДАНИИ НА СЕРВЕРЕ
	...
	Если НЕ Отказ Тогда
		...
		Элементы.ДекорацияНазначение.Видимость = ЗначениеЗаполненоОбъектСсылка и ЕстьПодчиненныеГруппеЭлементы(Объект.Ссылка);
