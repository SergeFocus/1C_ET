// sza150619-0057 формир поля печати
// sza150506-1446 формиров артикула
// sza141226-0230
// sza140928-1545
// sza140329-2252  
// sza130901-2212 : 
...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ОбменДанными.Загрузка 
		...
		Если НЕ ЭтоГруппа тогда
			...
			Если НЕ Отказ
				И ОбщийМодульПовтор.ПолучитьЗначениеНастройкиИлиКонстанты("СоздаватьГруппыНоменклПоПервомуСловуНаименИОтноситьКНим") Тогда
		...
		Если НЕ Отказ
			...
			ОбновитьПовторноИспользуемыеЗначения(); // цены, группы, енаименования на языках, набор, прочее
