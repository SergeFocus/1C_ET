...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТипДополнительногоРеквизита = ПредопределенноеЗначение("Перечисление.ТипыДополнительныхРеквизитов.СсылкаНаЭлементСправочника") Тогда
		...
		Если ТекущиеДанные.ЗначениеПоУмолчанию = Неопределено Тогда
			...
			ПоказатьВыборИзСписка(Новый ОписаниеОповещения("РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораЗавершение1", ЭтаФорма, Новый Структура("ТекущиеДанные, ТипДополнительногоРеквизита", ТекущиеДанные, ТипДополнительногоРеквизита)), ОбщийМодульКлиент.ПолучитьСписокИзМетаданных(ИСТИНА));
            Возврат;
		КонецЕсли;
		РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораФрагмент1(ТекущиеДанные);
	...
	ИначеЕсли ТипДополнительногоРеквизита = ПредопределенноеЗначение("Перечисление.ТипыДополнительныхРеквизитов.СсылкаНаДокумент") Тогда
		...
		Если ТекущиеДанные.ЗначениеПоУмолчанию = Неопределено Тогда
			ПоказатьВыборИзСписка(Новый ОписаниеОповещения("РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораЗавершение", ЭтаФорма, Новый Структура("ТекущиеДанные", ТекущиеДанные)), ОбщийМодульКлиент.ПолучитьСписокИзМетаданных(ЛОЖЬ));
            Возврат;
		КонецЕсли;
		РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораФрагмент(ТекущиеДанные);
...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораЗавершение1(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораФрагмент1(Знач ТекущиеДанные)
...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораЗавершение(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюНачалоВыбораФрагмент(Знач ТекущиеДанные)
...
&НаКлиенте
Процедура РеквизитыНоменклатурыЗначениеПоУмлчаниюОчистка(Элемент, СтандартнаяОбработка)
